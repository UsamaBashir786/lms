...
// Fetch all students
try {
    $stmt = $pdo->query("SELECT id, full_name, email, phone, dob, course, created_at FROM students ORDER BY created_at DESC");
                                ...
                                <?php else: ?>
                                    <?php foreach ($students as $student): ?>
                                        <tr>
                                            ...
                                            <td><?php echo date('M d, Y', strtotime($student['dob'])); ?></td>
                                            ...
                                            <td>
                                                ...
                                                <a href="?delete_id=<?php echo $student['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this student?');">Delete</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php endif; ?>
